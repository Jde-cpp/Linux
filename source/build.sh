...
if [ $clean -eq 1 ]; then
	...
	if [ $debug -eq 1 ]; then
		ccache g++-8 -c -g -fPIC -pthread -std=c++17 -Wall -Wno-unknown-pragmas -DJDE_NATIVE_EXPORTS -O0 -fsanitize=address -fno-omit-frame-pointer ./pc.h -o .obj/debug2/stdafx.h.gch -I/home/duffyj/code/libraries/json/include -I/home/duffyj/code/libraries/spdlog/include  -I$BOOST_ROOT -I../../Framework/source
	else
